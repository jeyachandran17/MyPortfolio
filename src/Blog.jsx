    ...
    <div className="node-container">
      ...
      <div className="node-contant">
        <div className="node-steps">
          ...
          <img src={nodedownloadpage} alt="nodejs download page" />
          <p>Step 2:</p>
          ...
          <img src={nodeinstallpage1} alt="" />
          <p>Select Next</p>
          <img src={nodeinstallpage2} alt="" />
          <p>Check “I accept the terms in the License Agreement” and Select Next</p>
          <img src={nodeinstallpage3} alt="" />
          <p>Select Next</p>
          <img src={nodeinstallpage4} alt="" />
          <p>Select Next</p>
          <img src={nodeinstallpage5} alt="" />
          ...
          <p>(or)</p>
          <p>Select Next</p>
          <img src={nodeinstallpage6} alt="" />
          <p>Select Install</p>
          <img src={nodeinstallpage7} alt="" />
          <p>Wait little bit time to installation on your computer</p>
          <img src={nodeinstallpage8} alt="" />
          <p>Select Finish</p>
          <img src={nodeinstallpage9} alt="" />
          <p>Now click start button and search cmd, than open the command prompt</p>
          <img src={nodeinstallpage10} alt="" />
